...
​	 本仓库作为本人学习机器学习、深度学习等领域的资料存储仓库，用于分享在学习过程中的一些感悟以及一些实用的学习资料。目标是在本科阶段发一篇SCI，然后能够考上理想院校的研究生，继续从事相关领域的研究工作。希望各位大佬对本人的学习过程提一些意见和建议，也欢迎各位同学一起讨论相关问题，希望大家都能成功上岸！

------

### 目前进度

- Machine Learning （学习ing）
